...
// From https://threejs.org/examples/files.js
// or generated from https://github.com/mrdoob/three.js/tree/dev/examples
const names = [
	'css2d_label',
	'css3d_molecules',
	'css3d_orthographic',
...
describe('Three.js examples', () => {
	names.forEach(id => {
		it(id, () => {
			...
			browser.get(`https://threejs.org/examples/${id}.html`);
			browser.wait(() => element(by.tagName('canvas')).isPresent(), 5000);
			browser.sleep(2500);
